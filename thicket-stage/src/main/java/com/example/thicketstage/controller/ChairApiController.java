...
public class ChairApiController {
    ...
    @Operation( summary = "단일 조회",
            description = "uuid 기준으로 좌석 1개를 조회합니다.",
    ...
    @Operation(summary = "전체 조회", description = "전체 좌석을 조회합니다.")
    ...
    @Operation( summary = "수정",
            description = "uuid 기준으로 좌석 1개를 수정합니다.",
             parameters = {@Parameter( name = "uuid",
    ...
    @Operation( summary = "삭제",
            description = "uuid 기준으로 좌석 1개를 삭제합니다.",
             parameters = {@Parameter(name = "uuid",
